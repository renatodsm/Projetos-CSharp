...
Você recebeu a tarefa de escrever testes unitários profissionais para a classe `ValidacoesLista`, que faz parte de um projeto .NET Core.

A classe `ValidacoesLista` contém métodos para manipular listas de números inteiros, incluindo a remoção de números negativos, verificação da presença de um número específico, entre outros.
...
Antes de começar, certifique-se de ter instalado o .NET Core SDK e o pacote `xunit`.


dotnet add package xunit
Escrevendo os Testes
Aqui está um exemplo de como escrever testes na classe ValidacoesListaTests.cs:
